...
$.statistics_table = function(tag, e) {
        ...
        var tmp_time = new Date( timepoint );

        $.initDatatable_2( tmp_time.getFullYear() + "-" + ( ( tmp_time.getMonth() < 10 ) ? "0" + ( tmp_time.getMonth() + 1 ).toString() : ( tmp_time.getMonth() + 1 ).toString() ) + "-" + ( ( tmp_time.getDate() < 10 ) ? "0" + ( tmp_time.getDate() ).toString() : ( tmp_time.getDate() ).toString() ) );
