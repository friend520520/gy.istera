    ...
    getCntAccountByYear: function(startData, endDate) {
        ...
        $.each( tmp , function( index , value ){
                ...
                var createLine = function(data) {
                    ...
                    target.append('<div class="col-lg-12" style="margin-bottom: 100px;">' + 
                                        select_range_input() +
                ...
                events: {
                    setExtremes: function (e) {
                        if ( e.DOMEvent && e.DOMEvent.type == 'mouseup'
                            ...
                            if( typeof initHighStockChart_cb != "undefined" )
...
var select_range_input = function() {
    var html = '<div style="float: right; margin-top: 20px;">\n\
                    <input id="startTime" style="width: 100px; border: 1px solid black; text-align: center; display : none;"> ~ \n\
                    <input id="endTime" style="width: 100px; border: 1px solid black; text-align: center; display : none;">\n\
                </div>'
    return html;
}
