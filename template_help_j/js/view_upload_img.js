...
function sendHtmlToServer( formData , file , status , func , event)
{
            if( $.upload_ask === "nobody" && func === "transient" ){
                ...
                var uploadURL ='php/mgm_static_pages.php?token=' + getCookie("help_cookie") + '&func=upload&file=' + event;
            }
            else{
                var uploadURL ='php/user_upload_image.php?token=' + getCookie("help_cookie") + '&func=' + func;
            }
