...
<head>
        ...
        <script type="text/javascript">
                ...
                $(function() {
                        ...
                        */
                        ...
                        $("#container").mousewheel( function(objEvent, intDelta) {
                                    ...
                                    var tmp_focus_get = $.highcharts_StockChart.highcharts().series[0].xAxis.getExtremes() ;

                                    // zoomRatio = zoomRatio + 1;

                                    // console.log( intDelta , zoomRatio );
                                    ...
                                    if( intDelta == 1 )
                                    {
                                                if( ( xMax - ( $.delta * $.tmp_delta_level / 20 ) ) > ( xMin + ( $.delta * $.tmp_delta_level / 20  ) ) )
                                                {
                                                $.highcharts_StockChart.highcharts().series[0].xAxis.setExtremes( ( xMin + ( $.delta * $.tmp_delta_level / 20  ) ) , ( xMax - ( $.delta * $.tmp_delta_level / 20 ) ) );
                                                //$.highcharts_StockChart.highcharts().series[1].xAxis.setExtremes( xMin + $.delta , xMax - $.delta );
                                    ...
                                    if( intDelta == -1 )
                                    {
                                                ...
                                                $.highcharts_StockChart.highcharts().series[0].xAxis.setExtremes( tmp_x1 , tmp_x2  );
                                                //$.highcharts_StockChart.highcharts().series[1].xAxis.setExtremes( tmp_x1 , tmp_x2  );
                                    }
                ...
                var setZoom = function( zoomRatio ) {   
                        ...
                        $.highcharts_StockChart.highcharts().series[0].xAxis.setExtremes( xMin - 100000 * zoomRatio  , 1466751430000 )
