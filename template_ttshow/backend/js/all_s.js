...
+function ($) {
  ...
  var Carousel = function (element, options) {
    ...
    this.options.pause == 'hover' && this.$element
      //.on('mouseenter', $.proxy(this.pause, this))     abin 2014.7.3
  ...
  // abin 2014.7.3 ++
  Carousel.prototype.know = function () {
    console.log(this);
  }
  // abin 2014.7.3 --
  ...
  Carousel.prototype.slide = function (type, next) {
    ...
    // abin 2014.7.3 ++
    if( $("#"+this.$element.attr("id"))[0]  == undefined ) {
            clearInterval(this.interval);
    }
    
    if($next.find("img").attr("src") == "" ) {

        $next.next().next().next().next().next().next().find("img").attr("src" ,  $next.next().next().next().next().next().next().find("img").attr("img_src") );
        $next.next().next().next().next().next().find("img").attr("src" ,  $next.next().next().next().next().next().find("img").attr("img_src") );
        $next.next().next().next().next().find("img").attr("src" ,  $next.next().next().next().next().find("img").attr("img_src") );
        $next.next().next().next().find("img").attr("src" ,  $next.next().next().next().find("img").attr("img_src") );
        $next.next().next().find("img").attr("src" ,  $next.next().next().find("img").attr("img_src") );
        $next.next().find("img").attr("src" ,  $next.next().find("img").attr("img_src") );
        $next.find("img").attr("src" ,  $next.find("img").attr("img_src") );
        console.log("change 7");
    }
    else if( $next.next().next().next().next().next().next().find("img").attr("src") == "" ) {  
        //console.log("next*7 src = '' ");
        //$next.next().next().next().next().next().next().find("img").attr("src" ,  $next.next().next().next().next().next().next().find("img").attr("img_src") );
        $next.next().next().next().next().next().find("img").attr("src" ,  $next.next().next().next().next().next().find("img").attr("img_src") );
        //$next.next().next().next().next().find("img").attr("src" ,  $next.next().next().next().next().find("img").attr("img_src") );
        //$next.next().next().next().find("img").attr("src" ,  $next.next().next().next().find("img").attr("img_src") );
  ...
  $.fn.carousel = function (option) {
    return this.each(function () {
      ...
      // abin 2014.7.3 ++
          ...
          console.log(data.options.interval);
          data.pause().cycle();
      }
      // abin 2014.7.3 --
      //else if (options.interval) data.options.interval = options.interval;data.pause().cycle();
    })
  }
