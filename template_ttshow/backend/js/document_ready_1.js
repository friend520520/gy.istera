...
/* a bin ++ 2014.5.30 edit*/
$.CGI_proxy = function ( type , url , data , data2 , back , error_back) 
{
           $.ajaxq( "CGI" , {
                       type : type ,
                       url : url ,
...
$.get_json_file = function ( url , data2  , back , error_back) 
{
           $.ajaxq( "json" , {
                       dataType : "script" ,
                       url : url ,
...
$.http_cds_json_file = function(data) {
            $.http_cds_json_file_data = data;
}
            ...
            $.View.view_tabs(); 
            $.View.view_sidebar();
            $.View.process_media_youtube();
            $.View.view_create_app();
            $.View.view_create_app().init();
            ...
            $( ".divFloatContainer[page_1_type=theme] , .divFloatContainer[page_1_type=mylove]" ).sortable({
                        //connectWith: ".connectedSortable"
                        connectWith: ".divFloatContainer"
