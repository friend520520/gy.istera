                                ...
                                <div class="page-content">
                                        <div style="font-size: 15px; line-height: 30px; letter-spacing: 1px; padding: 6px 100px 0px;" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                ...
                                                <div class="input-group" style="width: 100%">
                                                        ...
                                                        <div style="margin-bottom: 20px; display: block;" id="form_password">
                                                                <div>請輸入修改密碼</div>
                                                                <input id="password" type="password" class="form-control" placeholder="" style="margin: 5px 0;">
                                                        </div>
                                                    
                                                        <div style="margin-bottom: 20px; display: block;" id="form_password">
                                                                <div>再次確認密碼</div>
                                                                <input id="password2" type="password" class="form-control" placeholder="" style="margin: 5px 0;">
                                                        </div>
                                                        
                                                        <div id="save" style="height: 45px; cursor: pointer; text-align: center; border: 2px solid white; border-radius: 6px; float: right; background: rgb(24, 74, 117) none repeat scroll 0px 0px;" class="col-xs-6 col-sm-3">
                                                                <h3 style="color: white; text-align: center; font-size: 17px; margin: 10px;">儲存</h3>
                                                        </div>
                                                </div>
                                        </div>
