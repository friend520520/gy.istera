...
.nav-search-icon {
    ...
    top: -1px !important;
        ...
        <link href="css/wp-content.css" rel="stylesheet" type="text/css">
        ...
        <script src="js/tinymce.min.4.2.3.js"></script>
...
<body style="min-height: 660px; cursor: auto; overflow: hidden;" class="edit">
        ...
        <div class="main-container" id="main-container">
            <div class="container-full col-xs-9 col-sm-9 col-md-9 col-lg-9" style="padding: 15px; float: left; position: relative; top: 100px;" >
                    <div id="editor_place"></div>
                    <div id="eeeeee"></div>
                    <div id="editor_place_hide" style="display:none;"></div>
            </div>
            ...
            <div style="padding-right: 35px; top: 125px;" class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                    <div style="border-bottom: 1px solid rgb(229, 229, 229);" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="col-xs-12" style=" margin-bottom: 7%;">
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h4 style="font-weight: bold;" class="widget-title">插入圖片</h4>
                                    </div>

                                    <div class="widget-body">
                                        <div class="widget-main">
                                            <div>
                                                <button class="btn btn-default btn-xs" data-toggle="modal" data-target="#change_img_select_modal">插入圖片</button>
                                            </div>
                        ...
                        <div class="col-xs-12" style=" margin-bottom: 7%;">
                                <div class="widget-box">
                                    <div class="widget-header">
                                        <h4 style="font-weight: bold;" class="widget-title">發布時間</h4>
                                    </div>

                                    <div class="widget-body">
                                        <div class="widget-main">
                                            <div>
                                                <p id="ttshow_page_publish_time" type="text" style="width:100%; " ></p>
                                            </div>
...
<div id="save_file_success" aria-hidden="false" aria-labelledby="mySmallModalLabel" role="dialog" tabindex="-1" class="modal fade bs-example-modal-sm in">
        ...
        <script type="text/javascript" src="backend/js/view_shelldata.js"></script>
        <script type="text/javascript" src="backend/js/document_ready.js"></script>
        <script type="text/javascript" src="backend/ForTTShow/js/ttshow_document_ready.js"></script>
