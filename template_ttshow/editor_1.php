...
<head>
        ...
        <link href="backend/css/all.css" rel="stylesheet">
...
.nav-search-icon {
    ...
    top: -1px !important;
        ...
        <script type="text/javascript" src="backend/js/kernel/jquery-2.0.0.min.js"></script>
        <script src="js/device.js"></script>
        <script src="js/create.js"></script>
       
        <script type="text/javascript" src="backend/js/use/app.js"></script>
        <script type="text/javascript" src="backend/js/view_shelldata_1.js"></script>
        <script type="text/javascript" src="backend/js/all_s.js"></script>
        <script type="text/javascript" src="backend/js/ajaxq.js"></script>
        <script type="text/javascript" src="backend/js/jquery.htmlClean.js"></script>
        <script type="text/javascript" src="backend/js/all_ypcloud_layer_fliper.js"></script>
        <script type="text/javascript" src="backend/js/view_tabs.js"></script>
        <script type="text/javascript" src="backend/js/view_create_app.js"></script>
        <script type="text/javascript" src="backend/js/use/process_media_youtube.js"></script>
        <script type="text/javascript" src="backend/js/use/process_iframe.js"></script>
        <script type="text/javascript" src="backend/js/view_sidebar.jack.js"></script>
        <script src="backend/js/codemirror.js" charset="utf-8"></script>
        ...
        <script type="text/javascript" src="backend/js/document_ready_1.js"></script>
        <script type="text/javascript" src="backend/ForTTShow/js/ttshow_document_ready_1.js"></script>
        <script type="text/javascript" src="js/view_upload_img.js"></script>
        <script type="text/javascript" src="js/fb-login.js"></script>
</head>

<body style="min-height: 660px; cursor: auto; overflow: hidden;" class="edit">
    
        <div id="loadingpage" style="width: 100%; position: absolute; top: 0px; left: 0px; z-index: 9999; overflow: hidden; background: rgba(50, 50, 50, 0.4) none repeat scroll 0% 0%; height: 100%;">
                <div style="margin: auto; right: 0px; left: 0px; bottom: 0px; position: absolute; top: 0px; height: 1px; width: 1px;">
                        <i class="ace-icon loading-icon fa fa-spinner fa-spin fa-2x white" style="color: white; font-size: 40pt;"></i>
                </div>
        </div>
    
        <?php include( "header_1.php"); ?>
        
        <div style="position: fixed; width: 100%; left: 0px; padding: 0px 80px; z-index: 1000; top: 87px; background: white none repeat scroll 0% 0%; height: 45px;">
        ...
        <div class="container-full col-xs-9 col-sm-9 col-md-9 col-lg-9" style="display: none; padding: 15px; float: left; position: relative; top: 100px;" >
                <div class="row"><!-- jack -->
                        <div class="tool">
                                <div class="sidebar-nav" layer_id="1" layer_html="layout" style="left:0; top: 140px;" >
        ...
        <div style="padding-right: 35px; top: 125px;" class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                <div style="border-bottom: 1px solid rgb(229, 229, 229);" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="col-xs-12" style=" margin-bottom: 7%;">
                            <div class="widget-box">
                                <div class="widget-header">
                                    <h4 style="font-weight: bold;" class="widget-title">文章標題</h4>
                                </div>

                                <div class="widget-body">
                                    <div class="widget-main">
                                        <div>
                                            <input id="ttshow_page_name" type="text" class="form-control" value="" data-input="EVENT_Click" style="width:100%; " placeholder="請輸入標題">
                                        </div>
                    ...
                    <div class="col-xs-12" style=" margin-bottom: 7%;">
                            <div class="widget-box">
                                ...
                                <div class="widget-body">
                                    <div class="widget-main">
                                        <div>
                                            <select id="ttshow_channel_select" class="form-control">
                                            </select>
                                        </div>
                    ...
                    <div style=" margin-bottom: 7%;" class="col-xs-12">
                            <div class="widget-box">
                                <div class="widget-header">
                                    <h4 class="widget-title" style="font-weight: bold;">選擇分類</h4>
                                </div>

                                <div class="widget-body">
                                    <div class="widget-main">
                                        <div>
                                            <select multiple="multiple" id="ttshow_class_select" class="form-control">
                                            </select>
                                        </div>
                    ...
                    <div class="col-xs-12" style=" margin-bottom: 7%;">
                            <div class="widget-box">
                                <div class="widget-header">
                                    <h4 style="font-weight: bold;" class="widget-title">標籤</h4>
                                </div>

                                <div class="widget-body">
                                    <div class="widget-main">
                                        <div>
                                            <input id="ttshow_tag_name" type="text" placeholder="請輸入標籤名稱" style="width: 80%; float: left;" data-input="EVENT_Click" value="" class="form-control">
                                            <button id="ttshow_tag_add" class="btn btn-sm" style="float: left; margin-left: 5px; margin-top: 2px; border: 1px solid gray;">新增</button>
                                            
                                            <div class="clearfix"></div>
                                            
                                            <div id="ttshow_tag_space" style="padding: 5px 5px 0px; margin-top: 5px; border: 1px dashed gray; min-height: 30px;">
                                                    <div class="clearfix"></div>
                                            </div>
                                            
                                            <div class="clearfix"></div>
                                            
                                            <div id="ttshow_example_tag_model" style="display: none; padding: 4px 10px; background-color: rgb(145, 184, 208); float: left; margin-right: 5px; margin-bottom: 5px;">
                                                <button id="delete" style="float: left; margin-right: 5px;" type="button" class="close">×</button>
                                                <div id="text" style="float: left;">av</div>
                                            </div>
                                ...
                                <div class="widget-body">
                                    <div class="widget-main">
                                            <div class="form-group">
                                                    <input id="transient_file" type="file" target="upload_now" style="visibility: hidden;">
                                                    <div id="upload_cover_img" class="col-xs-12" style="height: 200px; width: 310px; border: 1px dashed black; padding: 0px;">
                                                            ...
                                                            <div id="transient_file_upload_loading" style="display: none; top: 0px; left: 0px; z-index: 9999; overflow: hidden; height: 200px; width: 310px; position: absolute; background: rgba(50, 50, 50, 0.4) none repeat scroll 0px 0px;">
                                                                    <div style="margin: auto; left: 0px; position: absolute; top: 0px; height: 1px; width: 1px; right: 30px; bottom: 31px;">
                                                                            <i style="color: white; font-size: 25pt;" class="ace-icon loading-icon fa fa-spinner fa-spin fa-2x white"></i>
                                                                    </div>
                                                            </div>
                                                    </div>
                                            </div>
                                            <label id="remove_cover_img" style="margin-top: 2%; width: 100%; color: #5599FF;">移除封面圖片</label>
                                    </div>
                                </div>
                            </div>
                    </div>
                    ...
                    <div class="col-xs-12" style="text-align: right; margin-bottom: 7%;">
                            <button id="ttshow_publish_page" class="btn btn-sm btn-primary">發布文章</button>
                    </div>
            </div>
        </div>
                                                ...
                                                <div class="row">
                                                            <div class="col-md-12">
                                                                        <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-7">
                                                                                                <input placeholder="http://" type="text" style="width:100%; " data-input="EVENT_Click" value="" id="FB_movie_input" class="form-control">
                                                                                    </div>
                                                                                    <div class="col-md-1"></div>
                                                                        </div>
                                                            </div>
                            ...
                            <div class="modal-body">
                                    <div style="position: relative; margin: auto; width: 100%; height: 200px; max-width: 600px; border: 1px solid rgb(221, 221, 221);">
                                            ...
                                            <div id="picture_upload" style="position: absolute; right: 0px; width: 35%; background: rgb(221, 221, 221) none repeat scroll 0% 0%; height: 100%; border: 1px solid gray;">
                                                    <div style="margin: 40px auto auto; right: 0px; left: 0px; position: absolute; top: 0px; width: 100px; bottom: 0px;"><img alt="ttshow" src="backend/ForTTShow/img/uplaod-01.png" style="width: 100px;"><div style="text-align: center; margin-top: 15px; font-size: 15pt;">上傳</div></div>
                                            </div>
                                    </div>
...
<div id="save_file_success" aria-hidden="false" aria-labelledby="mySmallModalLabel" role="dialog" tabindex="-1" class="modal fade bs-example-modal-sm in">
        <div class="modal-dialog modal-xs">
                <div class="modal-content">

                            <div class="modal-header">
                                        <div style="font-size: 24pt; margin-top: 20px; float: left;" id="save_file_title">
                                            發文完成
                                        </div>
                                    <div style="float: left; margin-left: 15px; font-size: 12pt; margin-top: 38px;">
                                        <a id="save_file_link" href="">瀏覽文章</a>
                                    </div>
                                    <button style="position: absolute; top: 0px; right: 0px; margin-top: 10px; margin-right: 10px;" type="button" class="close" data-dismiss="modal">
                                            <span aria-hidden="true">
                                                    <span class="glyphicon glyphicon-remove"></span>
