<?php 
        ...
        try
        {
                    ...
                    $jsonData{'specialtag'} = $_REQUEST['specialtag'];
                    $jsonData{'pageNumber'} = $_REQUEST['pageNumber'];
                    $json = list_specialtag( $contorl_table , $jsonData );
        ...
        function list_specialtag( $contorl_table , $jsonData ) {
                ...
                $specialtag = $jsonData{'specialtag'};
                ...
                if ($data->num_rows > 0) {
                    ...
                    $files{'specialtag'} = $jsonData{'specialtag'};
                }
