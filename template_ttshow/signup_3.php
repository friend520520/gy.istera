...
<html lang="en">
	...
	<body class="no-skin" style="background-color: #DDDDDD;">
        ...
        <div class="main-container" id="main-container" style="background-color: white;">
            <div id="" style="max-width: 800px; position: absolute; margin: 110px auto auto; right: 0px; left: 0px; background: none repeat scroll 0% 0% white;">
                    ...
                    <div style="text-align: center; font-weight: bold; top: 20px; position: relative; height: 50px; line-height: 50px; margin-bottom: 40px; font-size: 28pt;">認證完成</div>
