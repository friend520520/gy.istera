...
<html lang="en">
	...
	<body class="no-skin" style="background-color: #DDDDDD;">
        ...
        <div class="main-container" id="main-container" style="background-color: white;">
            <div style="max-width: 800px; position: absolute; margin: auto; right: 0px; left: 0px; margin-top: 85px;">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding: 30px; background: white;">
                            <div id="upload_place" style="margin: 0px 0px 30px; padding: 0px;" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <label class="col-xs-6 col-sm-6 col-md-6 col-lg-6" style="border-radius: 0px; display: inline-block; position: relative; text-align: center; background-color: rgb(30, 89, 144); padding: 15px 0px;">
                                            <div id="usericon" class="chessboard-icon bg_center" img="http://ttshow.tw/images/logo.png" style="position: absolute; margin: 0px auto; left: 0px; right: 0px; background-image: url('http://ttshow.tw/images/logo.png'); height: 49px; width: 60px; top: 15px;"></div>
                            ...
                            <div style="width : 70%; font-size: 12pt;">
                                    ...
                                    <div style="margin-bottom: 20px;">
                                            ...
                                            <input id="form_email" style="margin: 5px 0;" type="text" placeholder="" class="form-control">
        ...
        <script type="text/javascript">
                ...
                $("document").ready(function() {
                        ...
                        $( "#accept" ).unbind('click').bind( "click" , function(e) {
                                    ...
                                    if( $.getData["signup"] == "fb" ) {
                                            ...
                                            data.cmd = "addbyfb";
                                            data.facebook_mail = $.member.facebook_mail;
                                            facebook_apply( data );
                                            console.log( data );
                ...
                var process_inputdata = function() {
                        ...
                        var usericon = "";
                        if( $("#usericon").attr("img").lastIndexOf("facebook") == -1 && $("#usericon").attr("img") !== "http://ttshow.tw/images/logo.png" ) {
                                            ...
                                            try {
                                                    ...
                                                    if( data.success == "true" )
                                                    {
                                                            if( location.host === "www.ooxxoox.com" )
                                                                //var url = "../gmailsystem/confirm.php";
                                                                var url = "http://www.ggyyggy.com/bohan/gmailsystem/confirm.php";
                ...
                var insert_fbdata = function() {
                        ...
                        */
                        $("#usericon").css( "background-image" , "url('http://graph.facebook.com/" + $.member.id + "/picture')" );
                        $("#usericon").attr( "img" , "http://graph.facebook.com/" + $.member.id + "/picture" );
                        $("#form_email").val( $.member.facebook_mail );
                        $("#form_nickname").val( $.member.name );
                        $( "#loadingpage" ).hide();
                        //birthday       : bir ,
                        //sex            : $("input[name=form_sex]:checked").val() ,
